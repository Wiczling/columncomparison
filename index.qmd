...
ggsave(paste0("figures\\param\\", "column-effects-all", ".svg"), plot=p, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\param\\", "column-parameters-all", ".svg"), plot=p, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\param\\", "sd-column-effects-all", ".svg"), plot=p, width = 20, height = 15, units = "cm")
...
p3 <- ggplot()+
      geom_density(data = wpCond,aes(x=value, colour=variable, fill=variable),linetype = "solid") +
      geom_density(data = wpPred,aes(x=value, y = ..density..*100, colour=variable, fill=variable), linetype = "solid", alpha=0.1) +
...
ggsave(paste0("figures\\concordanceplots\\", "uncertainitychromatogram.joined", ".svg"), plot=p3, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\logPeffects\\logPjoined", ".svg"), plot=p+savetheme, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\casestudy1\\utilitymap\\",  "chromatogram", ".svg"), plot=p, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\casestudy2\\decision\\",  "chromatogram", ".svg"), plot=p, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\casestudy2\\utilitymap\\",  "chromatogram", ".svg"), plot=p, width = 20, height = 20, units = "cm")
