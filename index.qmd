...
author: "Agnieszka Kamedulska, Paweł Wiczling"
...
1.  we removed measurements with low score, analytes with less than 42 measurements per column, analytes with less than 210 measurements out of total 420, and used measurements with the highest score (If several were present)
...
2.  we removed some outlying measurements (mismatch between literature pKa and observed data)
...
3.  we prepared predictors: pKa, logP and functional_groups
...
# exclude functional groups that repeat itself
...
6.  we selected analytes with two or less dissociation steps
...
print(p)
ggsave(paste0("figures\\Predictors\\", "NoFunctionalGroups", ".png"), plot=p, width = 20, height = 20, units = "cm")
...
In this work $\small  z$ = 1..51915 denotes observation, $\small  i$=1..142 denotes analyte, $\small  c$=1..5 denotes column, $\small  m$=1..2 denotes organic modifier and $\small  r$=1..$\small R[i]$ denotes dissociation step for  $\small  i$-th analyte. The observed retention times ($\small t_{Robs,z}$) were modeled using the following model:
...
& S1_{m,c,i,r}  = f(S1mN_i,cS1mN_i, dS1mA_a, cdS1mA_a, S1mB_b, cdS1mB_b, dS1N_i, cdS1N_i, ddS1A_a, cddS1A_a, ddS1B_b, cddS1B_b) \\
...
2.  we created the batch file to run the code:
...
4.  finally we checked the diagnostics
...
```{r eval = FALSE}
 ...
 setwd("~/Tryton/CompareColumns/model-five-columns-priors-corr/stanfiles")
...
First plot presents parameter specific for XBridge Shield RP18 column and parameters commom for all the columns:
...
ggsave(paste0("figures\\Parameters\\", "Paramteres.XBridgeShieldRP18_1", ".png"), plot=p1, width = 20, height = 20, units = "cm")
ggsave(paste0("figures\\Parameters\\", "Paramteres.XBridgeShieldRP18_2", ".png"), plot=p2, width = 20, height = 20, units = "cm")
...
Effects relative to XBridge Shield RP18 column:
...
ggsave(paste0("figures\\Parameters\\", "Difference_1", ".png"), plot=p, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\Parameters\\", "Difference_2", ".png"), plot=p, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\Parameters\\", "Joined_Effects", ".png"), plot=p, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\Parameters\\", "Joined", ".png"), plot=p, width = 20, height = 20, units = "cm")
...
ggsave(paste0("figures\\Parameters\\", "Joined_SD", ".png"), plot=p1, width = 20, height = 10, units = "cm")
...
ggsave(paste0("figures\\ParametersIsocratic\\", paste(dataNames$Name[analyte_ID_sample[i]]), ".IsocraticPredictions", ".png"), plot=p, width = 20, height = 20, units = "cm")
...
p<-draws_df_subset %>%
 ...
 ggsave(paste0("figures\\ParametersIsocratic\\", paste(dataNames$Name[analyte_ID_sample[i]]), ".IsocraticDifferences", ".png"), plot=p, width = 20, height = 20, units = "cm")
...
print(p)
 ...
 ggsave(paste0("figures\\ParametersIsocratic\\", paste(dataNames$Name[analyte_ID_sample[i]]), ".filogk1", ".png"), plot=p, width = 20, height = 20, units = "cm")
}
```
...
<!-- ggsave(paste0("figures\\IndividualParameters\\", "XBridgeShieldRP18.NeutralForm", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!--  ggsave(paste0("figures\\IndividualParameters\\", "Differences.NeutralForm_1", ".png"), plot=p1, width = 20, height = 20, units = "cm") -->
<!--   ggsave(paste0("figures\\IndividualParameters\\", "Differences.NeutralForm_2", ".png"), plot=p2, width = 20, height = 20, units = "cm") -->
<!--    ggsave(paste0("figures\\IndividualParameters\\", "Differences.NeutralForm_3", ".png"), plot=p3, width = 20, height = 20, units = "cm") -->
...
<!-- print(p) -->
<!-- ggsave(paste0("figures\\IndividualParameters\\", "XBridgeShieldRP18.DissForm", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!-- ggsave(paste0("figures\\IndividualParameters\\", "Differences.DissForm_1", ".png"), plot=p1, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\IndividualParameters\\", "Differences.DissForm_2", ".png"), plot=p2, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\IndividualParameters\\", "Differences.DissForm_3", ".png"), plot=p3, width = 20, height = 20, units = "cm") -->
<!-- ``` -->
...
<!--         scale_alpha(guide = "none") -->
<!-- print(p) -->
<!-- ggsave(paste0("figures\\IndividualParameters\\", "pKas", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-etas-202307110838-1-8c69d0.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-etas-202307110838-1-8c69d0.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-etas-202307110838-3-8c69d0.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-etas-202307110838-4-8c69d0.csv' -->
<!--                                 )) -->
...
<!-- data_to_plot_param <- cbind(dataACD$logP[which(dataACD$METID %in% data$METID)],param1,cparam1,cparam2,cparam3,cparam4) -->
<!-- colnames(data_to_plot_param) <- c(expression('logP'[i]),expression('etaS1mN'),expression('etaS1mN_1'),expression('etaS1mN_2'), expression('etaS1mN_3'),expression('etaS1mN_4')) -->
...
<!-- data_to_plot_param <- cbind(dataACD$logP[which(dataACD$METID %in% data$METID)],param1,cparam1,cparam2,cparam3,cparam4) -->
<!-- colnames(data_to_plot_param) <- c(expression('logP'[i]),expression('etadS1N'),expression('etadS1N_1'),expression('etadS1N_2'), expression('etadS1N_3'),expression('etadS1N_4')) -->
...
<!--                         name == "cparam1" ~ "etalogkwN_1", -->
<!--                         name == "cparam2" ~ "etalogkwN_2", -->
<!--                         name == "cparam3" ~ "etalogkwN_3", -->
<!--                         name == "cparam4" ~ "etalogkwN_4" -->
<!--                         ))  %>%  -->
...
<!--  ggsave(paste0("figures\\EtaPlots\\", functionalgroupsnames[i,2], ".FunctionalGroups", ".png"), plot=p1, width = 20, height = 20, units = "cm") -->
...
<!-- ggsave(paste0("figures\\EtaPlots\\", "DissForms_1", ".png"), plot=p1, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\EtaPlots\\", "DissForms_2", ".png"), plot=p2, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\EtaPlots\\", "DissForms_3", ".png"), plot=p3, width = 20, height = 20, units = "cm") -->

<!-- ``` -->

<!-- # Comparison of observed and model predicted retention times -->

<!-- The model predictions were simulated using a more dense design. Two types of predictions (individual and population) are shown. The individual predictions are based on population-level parameters, predictors, and all of the observed retention time measurements. The population predictions are based on population-level parameters and predictors. -->

<!-- ```{r} -->
<!-- fitsim <- cmdstanr::as_cmdstan_fit(c( -->
<!--                                  # 'Tmpstan1/output_1.csv', -->
<!--                                  #  'Tmpstan1/output_2.csv', -->
<!--                                  # 'Tmpstan1/output_3.csv', -->
<!--                                  #  'Tmpstan1/output_4.csv', -->
<!--                                  # 'Tmpstan1/output_5.csv', -->
<!--                                  #  'Tmpstan1/output_6.csv', -->
<!--                                  # 'Tmpstan1/output_7.csv', -->
<!--                                   'Tmpstan1/output_8.csv' -->
<!--                                 )) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- x<- cmdstanr::read_cmdstan_csv(c( -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-sim-202307110842-1-1eabed.csv' -->
<!--                                 )) -->
...
<!-- ggsave(paste0("figures\\ConcordancePlots\\", paste(dataNames$Name[analyte_ID_sample[i]]), ".IndividualPredictions", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!-- ggsave(paste0("figures\\ConcordancePlots\\", paste(dataNames$Name[analyte_ID_sample[i]]), ".PopulationPredictions", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!-- ```{r} -->
<!-- x<- cmdstanr::read_cmdstan_csv(c( -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-epred-202307110853-1-5f2181.csv' -->
<!--                                 )) -->
...
<!-- ggsave(paste0("figures\\ConcordancePlots\\", "UncertainityChromatogram.IndividualPredictions", ".png"), plot=p1, width = 20, height = 20, units = "cm") -->

<!-- ggsave(paste0("figures\\ConcordancePlots\\", "UncertainityChromatogram.PopulationPredictions", ".png"), plot=p2, width = 20, height = 20, units = "cm") -->
...
<!-- print(p) -->
<!-- ggsave(paste0("figures\\ParametersIsocratic\\", paste(dataNames$Name[analyte_ID_sample[i]]), ".IsocraticPredictions.Population", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!--  ggsave(paste0("figures\\ParametersIsocratic\\", paste(dataNames$Name[analyte_ID_sample[i]]), "IsocraticDifferences.Population", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!--  ggsave(paste0("figures\\ParametersIsocratic\\", paste(dataNames$Name[analyte_ID_sample[i]]), "filogk1.Population", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!-- fit_logP  <- model_logP$generate_quantities(fit, -->
<!--                                          data = datastruct, -->
<!--                                          seed = 123, -->
<!--                                          parallel_chains = 4, -->
<!--                                          output_dir = "Tmpstan1") -->
...
<!-- ```{r} -->
<!-- x<- cmdstanr::read_cmdstan_csv(c( -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-logP-202307200849-1-8bfd80.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-logP-202307200849-2-8bfd80.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-logP-202307200849-3-8bfd80.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-logP-202307200849-4-8bfd80.csv' -->
<!--                                 )) -->
...
<!-- The following plots show the effect of logP on isocratic retention times (population predictions) for typical neutral, basic and acidic analyte. The uncertainties are large. They are not shown to improve visibility. -->
...
<!--   ggplot(aes(x = fi, y = mlogkPred, color = as.factor(r), fill = as.factor(r), linetype = as.factor(p))) + -->
<!--   geom_line() + -->
<!--   facet_grid(c~m,labeller = labeller(c=col.labs, m=mod.labs))+ -->
<!--   labs(color= "Type", linetype= "logP", y="typical logk",x="\u03C6")+ -->
<!--   scale_fill_discrete(labels= c("B", "N", "A")) + -->
<!--   scale_color_discrete(labels= c("B", "N", "A"))+ -->
<!--   scale_color_manual(labels = c("B", "N","A"), values = c("#619CFF", "black","#F8766D"))+ -->
<!--   scale_linetype_manual(labels= c("0", "3", "6"), values = c("dotted","solid", "dashed")) + -->
...
<!-- ```{r} -->
<!-- x<- cmdstanr::read_cmdstan_csv(c( -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-residuals-202307111057-1-736e65.csv' -->
<!--                                 )) -->
...
<!-- ggsave(paste0("figures\\ConcordancePlots\\", "Residuals", ".png"), plot=p1, width = 20, height = 20, units = "cm") -->
...
<!-- ggsave(paste0("figures\\ConcordancePlots\\", "CalibrationIndividual", ".png"), plot=p1, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\ConcordancePlots\\", "CalibrationPopulation", ".png"), plot=p2, width = 20, height = 20, units = "cm") -->
<!-- ``` -->

<!-- # Predictions and decision making. Case 1 -->

<!-- The proposed model can be used for decision making. We start by predicting XTerra MS C18, XBridge Phenyl, XBridge C8, Xterra MS C8 retention times based on XBridge Shield RP18 data. -->
...
<!--                                    'Tmpstan1/hplc-gra-fivecolumns-fixed-202307111154-1-71e4cf.csv', -->
<!--                                    'Tmpstan1/hplc-gra-fivecolumns-fixed-202307111154-2-71e4cf.csv', -->
<!--                                    'Tmpstan1/hplc-gra-fivecolumns-fixed-202307111154-3-71e4cf.csv', -->
<!--                                    'Tmpstan1/hplc-gra-fivecolumns-fixed-202307111154-4-71e4cf.csv' -->
<!--                                 )) -->
...
<!-- ```{r} -->
<!-- x<- cmdstanr::read_cmdstan_csv(c( -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-fixed-sim-202307111315-1-150940.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-fixed-sim-202307111315-2-150940.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-fixed-sim-202307111315-3-150940.csv', -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-fixed-sim-202307111315-4-150940.csv' -->
<!--                                 )) -->
...
<!-- ggsave(paste0("figures\\CaseStudy1\\ConcordancePlots\\", paste(dataNames$Name[analyte_ID_sample[i]]), ".IndividualPredictions", ".png"), plot=pi, width = 20, height = 20, units = "cm") -->
...
<!-- ggsave(paste0("figures\\CaseStudy1\\DecisionMaking\\", "ExpectedUtility", ".png"), plot=p1, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\CaseStudy1\\DecisionMaking\\",  "Resolution", ".png"), plot=p2, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\CaseStudy1\\DecisionMaking\\",  "maxtr", ".png"), plot=p3, width = 20, height = 20, units = "cm") -->
...
<!-- ggsave(paste0("figures\\CaseStudy1\\DecisionMaking\\",  "Chromatogram", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
<!-- ```{r} -->
<!-- x<- cmdstanr::read_cmdstan_csv(c( -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-fixed-sim-202307111318-1-382179.csv' -->
<!--                                 )) -->
<!-- draws_sim_red_df <- as_draws_df(x$generated_quantities) -->
...
<!-- ggsave(paste0("figures\\CaseStudy1\\UtilityMap\\",  "UtilityMap3", ".png"), plot=p12, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\CaseStudy1\\UtilityMap\\",  "UtilityMap4", ".png"), plot=p12, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\CaseStudy1\\UtilityMap\\",  "UtilityMap5", ".png"), plot=p12, width = 20, height = 20, units = "cm") -->
...
<!-- Predicting best chromatogram using all available data. -->

<!-- ```{r eval = FALSE} -->
<!-- fit_red2<- cmdstanr::as_cmdstan_fit(c( -->
<!--                                  # 'Tmpstan1/output_1.csv', -->
<!--                                  #  'Tmpstan1/output_2.csv', -->
<!--                                  # 'Tmpstan1/output_3.csv', -->
<!--                                  #  'Tmpstan1/output_4.csv', -->
...
<!-- ```{r} -->
<!-- x<- cmdstanr::read_cmdstan_csv(c( -->
<!--                                   'Tmpstan1/hplc-gra-fivecolumns-fixed-sim-202307111330-1-03c933.csv' -->
<!--                                 )) -->
<!-- draws_sim_red_df <- as_draws_df(x$generated_quantities) -->
...
<!-- ggsave(paste0("figures\\CaseStudy2\\UtilityMap\\",  "UtilityMap3", ".png"), plot=p12, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\CaseStudy2\\UtilityMap\\",  "UtilityMap4", ".png"), plot=p12, width = 20, height = 20, units = "cm") -->
<!-- ggsave(paste0("figures\\CaseStudy2\\UtilityMap\\",  "UtilityMap5", ".png"), plot=p12, width = 20, height = 20, units = "cm") -->
...
<!-- ggsave(paste0("figures\\CaseStudy2\\UtilityMap\\",  "Chromatogram2", ".png"), plot=p, width = 20, height = 20, units = "cm") -->
...
1.	Kamedulska A, Kubik Ł, Jacyna J, Struck-Lewicka W, Markuszewski MJ, Wiczling P. Toward the General Mechanistic Model of Liquid Chromatographic Retention. Anal Chem. 2022 Aug 9;94(31):11070-11080. doi: 10.1021/acs.analchem.2c02034..
2.	Kamedulska A, Kubik Ł, Wiczling P. Statistical analysis of isocratic chromatographic data using Bayesian modeling. Anal Bioanal Chem. 2022 May;414(11):3471-3481. doi: 10.1007/s00216-022-03968-x..
3.	Wiczling P, Kamedulska A, Kubik Ł. Application of Bayesian Multilevel Modeling in the Quantitative Structure-Retention Relationship Studies of Heterogeneous Compounds. Anal Chem. 2021 May 11;93(18):6961-6971. doi: 10.1021/acs.analchem.0c05227.
4.	Kubik Ł, Kaliszan R, Wiczling P. Analysis of Isocratic-Chromatographic-Retention Data using Bayesian Multilevel Modeling. Anal Chem. 2018 Nov 20;90(22):13670-13679. doi: 10.1021/acs.analchem.8b04033.
5.	Kubik Ł, Jacyna J,  Struck-Lewicka W, Markuszewski M, Wiczling P, LC-TOF-MS data collected for 300 small molecules. XTerra MS C18 column. DOI 10.17605/OSF.IO/QBV7J
6.	Kubik Ł, Jacyna J,  Struck-Lewicka W, Markuszewski M, Wiczling P, LC-TOF-MS data collected for 300 small molecules. XBridge Shield RP18 column. DOI 10.17605/OSF.IO/ZQTJ7
8.	Kubik Ł, Jacyna J,  Struck-Lewicka W, Markuszewski M, Wiczling P, LC-TOF-MS data collected for 300 small molecules. XTerra-C8 column. DOI 10.17605/OSF.IO/2MCNW
9.	Kubik Ł, Jacyna J,  Struck-Lewicka W, Markuszewski M, Wiczling P, LC-TOF-MS data collected for 300 small molecules. XBridge Phenyl column.  DOI 10.17605/OSF.IO/EVUJ9
10.	Kubik Ł, Jacyna J,  Struck-Lewicka W, Markuszewski M, Wiczling P, LC-TOF-MS data collected for 300 small molecules. XBridge-C8 column. DOI 10.17605/OSF.IO/Y6S8P
11. Nikitas, P.; Pappa-Louisi, A. New equations describing the combined effect of pH and organic modifier concentration on the retention in reversed-phase liquid chromatography. Journal of Chromatography A 2002, 971 (1), 47–60. https://doi.org/10.1016/S0021-9673(02)00965-2.  
