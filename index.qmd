...
ggsave(paste0("figures\\param\\", "column-effects-all-manuscript", ".png"),
       p,
       device = ragg::agg_png(width = 8.4582, height = 8.4582, units = "cm", res = 300, scaling=0.5))
```
...
ggsave(paste0("figures\\param\\", "sd-column-effects-all-manuscript", ".png"),
       p,
       device = ragg::agg_png(width = 8.4582, height = 6.34365, units = "cm", res = 300, scaling=0.5))
