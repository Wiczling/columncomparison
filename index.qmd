...
ragg::agg_png(paste0("figures\\param\\", "column-effects-all-figures", ".png"), 
              width = 8.4582, height = 8.4582, units = "cm", res = 300, scaling=0.42291)
grid.arrange(p)
dev.off()
```
...
ragg::agg_png(paste0("figures\\param\\", "column-parameters-all-figures", ".png"), 
              width = 8.4582, height = 8.4582, units = "cm", res = 300, scaling=0.42291)
grid.arrange(p)
dev.off()
...
ragg::agg_png(paste0("figures\\param\\", "sd-column-effects-all-paper", ".png"), 
              width = 8.4582, height = 6.34365, units = "cm", res = 300, scaling=0.42291)
grid.arrange(p)
dev.off()
...
savetheme <- theme(
        ...
        strip.text.x = element_text(size = 4, margin = margin(.05, 0, .05, 0, "cm")),
        strip.text.y = element_text(size = 4, margin = margin(.05, 0, .05, 0, "cm")), 
        legend.key.size = unit(0.25, 'cm'))


ggsave(paste0("figures\\concordanceplots\\", "uncertainitychromatogram.joined", ".png"), plot=p3, width = 20, height = 20, units = "cm")
ggsave(paste0("figures\\concordanceplots\\", "uncertainitychromatogram.joined", ".tiff"), plot=p3+savetheme, width = 8.4582, height = 8.4582, units = "cm", dpi=300)
...
ggsave(paste0("figures\\logPeffects\\logPjoined", ".tiff"), plot=p+savetheme, width = 8.4582 , height = 8.4582 , units = "cm",dpi=300)

ragg::agg_png(paste0("figures\\logPeffects\\logPjoined-figures", ".png"), 
              width = 8.4582, height = 8.4582, units = "cm", res = 300, scaling=0.42291)
print(p)
dev.off()
...
cat("1. The best for XBridge Shield RP18:")
 Uresults1<-Uresults[Uresults$Column==1 & Uresults$pHo<7,];
...
cat("2. The best choice for XTerra MS C18:")
 Uresults2<-Uresults[Uresults$Column==2& Uresults$pHo<7,];
...
cat("3. The best choice for XBridge Phenyl:")
 Uresults3<-Uresults[Uresults$Column==3& Uresults$pHo<7,];
...
cat("4. The best choice for XBridge C8:")
 Uresults4<-Uresults[Uresults$Column==4& Uresults$pHo<7,];
...
cat("5. The best choice for Xterra MS C8:")
 Uresults5<-Uresults[Uresults$Column==5& Uresults$pHo<7,];
...
ggsave(paste0("figures\\casestudy1\\utilitymap\\",  "chromatogram", ".tiff"), plot=p+savetheme, width = 8.4582, height = 8.4582, units = "cm", dpi=300)
print(p)
```
...
ragg::agg_png(paste0("figures\\casestudy2\\utilitymap\\",  "chromatogram-figures", ".png"), 
              width = 8.4582, height = 8.4582, units = "cm", res = 300, scaling=0.42291)
grid.arrange(p)
dev.off()
