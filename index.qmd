...
The list of packages used in this analysis:
...
4.  we selected analytes with two or less dissociation steps
...
```{r eval = FALSE, echo=FALSE}
 x<-fit$summary(variables = c("logkwHat","S1mHat","dS1Hat",
             ...
             "capH",
             "comega", "ckappa", "comegaT",
             "clogmsigma","cssigma", "rho[2,1]", "crho"), "mean", "sd")
...
```{r}
x<- cmdstanr::read_cmdstan_csv(c(
                                  'stanfiles/hplc-gra-fivecolumns-epred-202308090811-1-779433.csv'
                                ))
...
```{r}
x<- cmdstanr::read_cmdstan_csv(c(
                                  'stanfiles/hplc-gra-fivecolumns-logP-202308082058-1-09b416.csv',
                                  'stanfiles/hplc-gra-fivecolumns-logP-202308082058-2-09b416.csv',
                                  'stanfiles/hplc-gra-fivecolumns-logP-202308082058-3-09b416.csv',
                                  'stanfiles/hplc-gra-fivecolumns-logP-202308082058-4-09b416.csv'
                                ))
...
```{r}
x<- cmdstanr::read_cmdstan_csv(c(
                                  'stanfiles/hplc-gra-fivecolumns-residuals-202308082123-1-1fff1f.csv'
                                ))
...
Predicting best chromatogram using all the available data.
...
fit_red <- cmdstanr::as_cmdstan_fit(c(
                                  'stanfiles/hplc-gra-fivecolumns-fixed-202308090920-1-544cd2.csv',
                                  'stanfiles/hplc-gra-fivecolumns-fixed-202308090920-2-544cd2.csv',
                                  'stanfiles/hplc-gra-fivecolumns-fixed-202308090920-3-544cd2.csv',
                                  'stanfiles/hplc-gra-fivecolumns-fixed-202308090920-4-544cd2.csv'
...
7.  Kubik Ł, Jacyna J, Struck-Lewicka W, Markuszewski M, Wiczling P, LC-TOF-MS data collected for 300 small molecules. XTerra-C8 column. DOI 10.17605/OSF.IO/2MCNW
8.  Kubik Ł, Jacyna J, Struck-Lewicka W, Markuszewski M, Wiczling P, LC-TOF-MS data collected for 300 small molecules. XBridge Phenyl column. DOI 10.17605/OSF.IO/EVUJ9
9.  Kubik Ł, Jacyna J, Struck-Lewicka W, Markuszewski M, Wiczling P, LC-TOF-MS data collected for 300 small molecules. XBridge-C8 column. DOI 10.17605/OSF.IO/Y6S8P
10. Nikitas, P.; Pappa-Louisi, A. New equations describing the combined effect of pH and organic modifier concentration on the retention in reversed-phase liquid chromatography. Journal of Chromatography A 2002, 971 (1), 47--60. https://doi.org/10.1016/S0021-9673(02)00965-2.
