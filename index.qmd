...
draws_df_subset <- fit$draws(format = "df", variable = c("comega","ckappa","crho"))
...
ggsave(paste0("figures\\param\\", "sd-column-effects-all", ".png"), plot=p, width = 20, height = 10, units = "cm")
ggsave(paste0("figures\\param\\", "sd-column-effects-all", ".pdf"), plot=p, width = 20, height = 10, units = "cm")
...
ggsave(paste0("figures\\concordanceplots\\", "residuals", ".pdf"), plot=p1, width = 20, height = 20, units = "cm")
...
cat(" The best choice for XTerra MS C18:")
...
cat(" The best choice for XBridge Phenyl:")
...
cat(" The best choice for XBridge C8:")
...
cat(" The best choice for Xterra MS C8:")
...
ggsave(paste0("figures\\casestudy2\\decision\\", "expectedutility", ".pdf"), plot=p1, width = 20, height = 20, units = "cm")
ggsave(paste0("figures\\casestudy2\\decision\\",  "resolution", ".pdf"), plot=p2, width = 20, height = 20, units = "cm")
ggsave(paste0("figures\\casestudy2\\decision\\",  "maxtr", ".pdf"), plot=p3, width = 20, height = 20, units = "cm")

print(p1)
print(p2)
print(p3)

cat("1. The best choice for XBridge Shield RP18")
...
ggsave(paste0("figures\\casestudy2\\decision\\",  "chromatogram", ".pdf"), plot=p, width = 20, height = 20, units = "cm")
