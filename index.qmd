...
Other plors provide a summury of column effects (relative to XBridge Shield RP18 column):
...
p3 <- ggplot()+
     ...
     labs(title="uncertainty chromatogram",
          x ="Retention time, min",
          y = "pdf",
          colour="Analyte")+
     xlim(c(0,80))+
...
p<-draws_df_subset %>%
  ...
  ggplot(aes(x = fi, y = mlogkPred, color = as.factor(c), fill = as.factor(r), linetype = as.factor(m))) +
  geom_line() +
