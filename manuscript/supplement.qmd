...
Predictions represented as posterior median (line) and 5th-95th percentiles (areas) for 6 exemplary analytes. Observed retention factors are shown as dots. Predictions corresponding to future observations given  population-level parameters and predictors (logP and pKa) and XBridge Shield RP18 data.
...
{{< pagebreak >}}
# Figure S7. Individual izocratic predictions.
...
{{< pagebreak >}}
# Figure S8. Population isocratic predictions.
...
{{< pagebreak >}}
# Figure S9. Uncertainity chromatograms
...
![](../figures/casestudy2/utilitymap/chromatogram.pdf)
